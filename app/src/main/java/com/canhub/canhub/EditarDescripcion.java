...
public class EditarDescripcion extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_editar_descripcion, container, false);

        editDes = view.findViewById(R.id.editDescripcion);
        btnGuardar = view.findViewById(R.id.btnGuardar);

        btnGuardar.setOnClickListener(v -> {
            String nuevaDescripcion = editDes.getText().toString().trim();
